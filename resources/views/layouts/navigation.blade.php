<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                   ...
                   <x-dropdown align="left" width="48">
                    <x-slot name="trigger">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('estoque.listacompra')">
                                {{ __('Lista de Compras') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('estoque.index')">
                                {{ __('Relatórios') }}
                    ...
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('despesas.index')">
                                {{ __('Despesas') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Dropdown de Pedidos Responsivo -->
            <x-responsive-nav-link>
                <button class="w-full text-left">
                    {{ __('Pedidos') }}
                    <svg class="ml-1 h-4 w-4 inline-block" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
