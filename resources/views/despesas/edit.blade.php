<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar Despesa #{{ $despesa->id }}</h2>
    </x-slot>
    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <form action="{{ route('despesas.update', $despesa) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
